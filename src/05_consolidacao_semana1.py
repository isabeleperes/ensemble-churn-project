# -*- coding: utf-8 -*-
"""
Consolidação da Semana 1 — validação cruzada e comparação final entre os
três modelos de árvore de decisão (padrão, podada e otimizada via GridSearchCV).
"""
...
#%% Validação cruzada K-fold estratificada (5 partições)
...
#%% Treinar os 3 modelos da semana e comparar lado a lado
...
print("\nTabela salva em images/tabela_resultados_semana1.csv")

#%% Relatório de classificação dos 3 modelos
for nome, modelo in modelos.items():
    y_pred = modelo.predict(X_teste)
    print(f"\n{'='*50}")
